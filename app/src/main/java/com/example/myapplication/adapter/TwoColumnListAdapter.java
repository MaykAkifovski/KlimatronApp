...
public class TwoColumnListAdapter extends ArrayAdapter<IdAndBoardName> {

    private LayoutInflater mInflater;
    private List<IdAndBoardName> idAndBoardNames;
    private int mViewResourceId;

    public TwoColumnListAdapter(Context context, int textViewResourceId, List<IdAndBoardName> idAndBoardNames) {
